## This pod document is for Demeter version 0.9.10.
...
the installer package.  The latest version can be found at
L<https://github.com/bruceravel/demeter/downloads>.  Download,
double-click, follow the instructions.  It should be that simple.
...
Download the Ifeffit source code from the 
L<Ifeffit Downloads page|http://cars9.uchicago.edu/ifeffit/Downloads>
