...
It is B<not> sufficient to simply install the updater.  You must
...
In a section below
(see L<Installing Demeter without root privileges>)
...
post|http://millenia.cars.aps.anl.gov/pipermail/ifeffit/2016-July/012608.html>
...
bug|http://sourceforge.net/p/pdl/mailman/pdl-devel/?viewmonth=201605&viewday=12>
in L<PDL::Stats> that is not yet fixed (at the time of this writing,
Aug. 2016) in the upstream source.  If possible, use your system's
...
thread|http://millenia.cars.aps.anl.gov/pipermail/ifeffit/2016-August/012679.html>,
do the following:
