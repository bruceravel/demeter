...
optinal C<--plot> command line switch.
...
in the documentation for L<Ifeffit::Demeter::Data>.  For instance,
...
forward Fourier transform kmin value:
  ...
  lsprj my.prj --params=bkg_rbkg,fft_kmin,
   ==prints==>
        1 : HgO        bkg_rbkg=1.0    fft_kmin=2
        2 : HgS black  bkg_rbkg=1.0    fft_kmin=2
        3 : HgS red    bkg_rbkg=1.0    fft_kmin=2

=back

=head1 DEPENDENCIES

This uses L<Ifeffit::Demeter> and its dependencies.
