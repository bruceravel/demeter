...
Write a space group summary

=item C<-r>

Specify a cluster size from the command line.

  atoms -r 5.2 mydata.inp
...
See L<Ifeffit::Demeter::Atoms> for bugs and limitations of the
...
snarf atoms.inp files from Matt's database
