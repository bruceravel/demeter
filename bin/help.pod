## This pod document is for Demeter version 0.9.9.
...
world's expert practitioners of XAS and it handles dozens of quesions
evefry month.  It should be the first place you go when you have a
...
a response.  There are many problems with vague, open-ended
questions.  The person asking such a question probably has not
spent much time thinking about the problem.  And it is not clear how
long the person answering will have to spend explaining the answer.
...
L<http://cars9.uchicago.edu/iffwiki/Downloads> and information about
Athena, Artemis, and Hephaestus can be found at
L<http://bruceravel.github.com/demeter>, including documentation.
...
authoritatively.  The PI of the Feff project and his students all read
...
The Feff9 document, in wiki firmat is at
