...
*** Athena
   ...
   - added "Shrink" to plot options.  this hides the plot options
     tabs, allowing more room for the group list.  also shows a button
     for restoring the plot options tabs
