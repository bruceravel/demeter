...
*** Demeter
   + DEMETER_BACKEND and DEMETER_DEVFLAG environment variables
     - export DEMETER_BACKEND = ifeffit|larch to control which backend is used
     - export DEMETER_DEVFLAG = 0|1 to control whether development screen messages are echoed
   ...
   + method for finding peak position of white line
