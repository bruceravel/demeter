...
*** Top of the to do list for 0.9.19:
...
With so many new features and bug fixes, I owe a big "Thank You!" to lots of people:
   ...
   + _Shelly Kelly_ (for pointing out bugs involving background removal standards and
     importing chi(k) data  and for suggesting improvements to the Intrp page)
   ...
   + _Kevin Jorissen_ (for suggesting direct linking to on-line Feff document)
