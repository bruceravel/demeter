...
*** Hephaestus
   ...
   - added tool for looking at Shannon atomic radii using json version
     of [[http://v.web.umkc.edu/vanhornj/Radii.txt][David van Horn's]] compilation of the [[http://dx.doi.org/10.1107/S0567739476001551][Shannon data]]
...
*** Demeter
   ...
   - implement a functional normalization for use in low energy
     fluorescence data where I0 changes a lot over the course of the
     scan.  this divides mu(E) by (post-pre) before removing
