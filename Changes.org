...
*** Athena
   ...
   - inv bug in Col Sel dialog (thanks to Ian Rosbottom)
   - Busy cursor in column & project selection dialogs on Windows
     (thanks to Ian Godrey)
...
*** Artemis
   - Disable run atoms and run feff buttons after first DnD (thanks to
     Yanyun Hu)
