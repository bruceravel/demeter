## This pod document is for Demeter version 0.9.23.
...
list|http://millenia.cars.aps.anl.gov/mailman/listinfo/ifeffit>.  This
...
Scott Calvin's book I<XAFS for Everyone> is my favorite XAFS textbook.
L<(Amazon
link)|http://www.amazon.com/XAFS-Everyone-Scott-Calvin/dp/1439878633/>

Grant Bunker's book, I<Introduction to XAFS: A Practical Guide
to X-ray Absorption Fine Structure Spectroscopy>, is also an excellent
resource.  L<(Amazon
...
You can download Demeter with Ifeffit from
L<http://bruceravel.github.io/demeter>.  The Demeter installer
for Windows is at L<http://bruceravel.github.io/demeter>.
General information about Athena, Artemis, and Hephaestus can be found
at L<http://bruceravel.github.io/demeter>, including documentation.

The lectures the Bruce gives at XAS training courses can be found at
L<http://bruceravel.github.io/XAS-Education>.  Those are
...
the L<Ifeffit mailing list|http://millenia.cars.aps.anl.gov/mailman/listinfo/ifeffit>
and often answer questions posted there.
