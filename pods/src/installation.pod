...
Frank Schima has performed yeoman's duty by making Demeter and its
tool chain available on Macports.  Thus far, testing has only been
done for OS X Mavericks and Mountain Lion.

At this time, the Mac packages should be considered as a release
candidate.  Some functionality may not yet be present.  If you run
into problems, use L<The Ifeffit mailing
...
saying I<"This is my problem and this what I've tried so far to fix it">
is much more valuable than just I<"This is my problem.">
...
Not yet available because no one has stepped up and make linux packages.
