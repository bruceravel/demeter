...
<<<<<<< HEAD
Use the L<Ifeffit mailing list|http://millenia.cars.aps.anl.gov/mailman/listinfo/ifeffit>.  The
=======
Use the L<Ifeffit mailing
lL<ist|http://millenia.cars.aps.anl.gov/mailman/listinfo/ifeffit>.  Th>e
...
lL<ist|http://millenia.cars.aps.anl.gov/mailman/listinfo/ifeffit> an>d
