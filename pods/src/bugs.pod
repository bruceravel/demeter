...
the softare.  There are good reasons for ths:
...
or Artemis crashes hard, some useful infromation is usually provided.
...
justify a period of silence).  Bruce takes bugs reports very seriousl,
