...
Suppose you wanted to mix some cobalt ferrite with 35 milligrams of
boron nitride measured above in order to make a good transmission XAS
...
the Co K edge.  28.3 milligrams represents about 7 absorption lengths
...
milligrams of ferrite with the BN will result is a sample of about 2.2
absorption lengths.  This will attenuate the beam to the level of
