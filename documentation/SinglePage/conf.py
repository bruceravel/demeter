...
latex_documents = [
  ('index', 'SingleFile.tex', u'SingleFile Documentation',
...
man_pages = [
    ('index', 'athena', u'SingleFile Documentation',
     [u'Bruce Ravel'], 1)
]
...
texinfo_documents = [
  ('index', 'SingleFile', u'SingleFile Documentation',
   u'Bruce Ravel', 'SingleFile', 'One line description of project.',
   'Miscellaneous'),
]
