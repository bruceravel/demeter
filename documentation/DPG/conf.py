...
project = u'Demeter Programming Guide'
...
# of the sidebar.
html_logo = '../_images/Isis-Sothis-Demeter_sm.jpg'
...
latex_documents = [
  ('index', 'Demeter.tex', u'Demeter Programming Guide',
...
man_pages = [
    ('index', 'athena', u'Demeter Programming Guide',
     [u'Bruce Ravel'], 1)
]
...
texinfo_documents = [
  ('index', 'Demeter', u'Demeter Programming Guide',
   u'Bruce Ravel', 'Demeter', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Demeter Programming Guide'
