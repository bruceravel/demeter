...
first column contains the energy, this string should be C<$1>.
...
transmission data and I0 is in the 2nd column, thus the default for
this string is C<$2>.
...
computing mu(E).  For example, the default is that these are
transmission data and transmission is in the 3nd column, thus the
