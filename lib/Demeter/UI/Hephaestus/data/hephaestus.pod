...
absorption length of 1, one must weigh out about 175 milligrams of BN.
In practice, this is quite a lot of BN and will make a rather thick
pellet.  One might weight out a fraction of the 175 milligrams for a
real sample, giving the matrix that much less than 1 absorption length.
...
Suppose you wanted to mix some cobalt ferrite with 35 milligrapms of
boron nitride measured above in order to make a good tranmission XAS
sample.  That amount of BN contributes 0.2 absorption lengths to the
total thickness of the sample at this energy.  Weighing out 4
milligrams of ferrite, then, gives the sample a total absorption of
1.2.  That is, the beam passing through the sample will attenuate to
...
That sample will have an edge step of about 0.14 through the Co edge.
That is because the second calculation tells you that you need 28.3
milligrams of ferrite in your 1 square centimeter sample to make an
edge step of 1.  With 4 milligrams, the edge step will be about
4/28.3 = 0.14.

A sample with an edge step of 1 is made by mixing 28.3 milligrams of
ferrite with the BN.  This sample, however, will be very thick around
the Co K edge.  28.3 miligrams represents about 7 absorption lengths
of ferrite.  The ferrite in BN will, therefore, attenuate the beam
passing through the sample to the level of exp(-7.2), or about 0.07%.
Only a trickle of X-rays will pass through the sample.

It is, therefore, impossible to optimize both total absorption and
edge step absorption for this sample.  Indeed, that is true of most
materials.  In this case, a good compromise would be to make the total
absorption a bit thick and the edge step a bit small.  Mixing 8
miligrams of ferrite with the BN will result is a sample of about 2.2
absorption lengths.  This will attenuiate the beam to the level of
about 11% -- still plenty of photons for the transmission chamber.
The edge step will be around 0.28 -- a quite respectable value.

As a final note, the calculation of absorption length in units of
length, in this case 8.2 microns, is another useful metric for high
quality sample preparation.  To mix ferrite powder with BN to obtain a
nicely homogeneous sample, it is necessary that the ferrite powder be
...
common stack of seives -- has openings of 37 microns.  That is vastly
