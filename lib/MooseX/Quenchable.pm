...
{
  $MooseX::Quenchable::VERSION = '0.9.26';
}
use Moose::Role 0.90;
use MooseX::Aliases;
...
{
  $MooseX::Quenchable::Attribute::VERSION = '0.9.26';
}
use Moose::Role 0.90;
...
{
  $MooseX::Quenchable::Accessor::VERSION = '0.9.26';
}
use Moose::Role 0.90;
...
{
  $Moose::Meta::Attribute::Custom::Trait::Quenchable::VERSION = '0.9.26';
}
