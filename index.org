...
** Demeter bugs and shortcomings  [0/9]
...
*** needs doing [2/4]
   ...
   - [X] in project selection dialog, controls for entering a periodic
         ...
         be nice
   - [ ] replot upon group selection, space is configurable (E, k, R, q, specialty, none)
   - [ ] buttons on difference tool are not working
...
*** LCF needs doing [8/10]
   ...
   - [ ] make group from fit button does nothing (use InsertData method)
...
* Weird stuff I'd prefer not to implement unless demanded
 ...
 8. plot margin lines for deglitching, deglitch many points (this was
    something that was most useful for a timeing problem at 10ID that
    no longer exists)
