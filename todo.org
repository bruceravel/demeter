...
** Artemis
*** Artemis bugs and missing features [6/17]  [35%]
   - [X] rename Atoms/Feff
   ...
   - [ ] In GDS, all in type column after #13 are text rather than combobox
   - [ ] force update of fit description when changing chi(k)
