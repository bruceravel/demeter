...
* top of the to do list [2/4]

  1. [X] Andreas' issues with LCF (se mail 16 June 05:47:33 am)
  2. [ ] Shelly's atoms bug (see mail 17 June 06:35:58 pm)
  3. [X] +Test fitting in k+
  4. [ ] Reading .fit file into dathena
...
** Windows issues [8/15]					    :Windows:
  ...
  - [ ] Get .prj file to open with a double click into Athena, .fpj into Artemis
