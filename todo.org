...
** Demeter bugs and shortcomings  [3/16] [18%]
  ...
  - [ ] better detection of chi ascii data in case of
...
** Artemis
*** Artemis bugs and missing features [2/13]
   ...
   - [X] update pods for D::Feff::Histogram and D::Feff::DL_POLY
   - [ ] rename Atoms/Feff
   ...
   - [ ] fit history plotting tool is broken -- it seems that previous
