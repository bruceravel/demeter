...
** big things
  ...
  - [ ] persistance of analysis methods in Athena
        This can be implemented in the same way I implemented XDI persistance -- for each group, serialize a blessed scalar and write that to the record
...
+ [ ] testing of Larch + XDI & of Larch - XDI
